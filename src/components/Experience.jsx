...
const experiences = [
  {
    company: "Baseel Partners LLP",
    period: "August 2024 - Feb 2025",
    position: "Frontend Developer Intern",
    description:
      "Contributed to the development of multiple modules across various projects using React.js, Next.js, and TypeScript. Collaborated with cross-functional teams in an Agile environment and participated in testing and performance optimization.",
  },
  {
      ...
      <div className="flex flex-col gap-12 relative z-10 pl-12 sm:pl-16 md:pl-20 lg:pl-24">
        {experiences.map((exp, index) => (
          ...
          >
            ...
            <div
              className="bg-slate-800/70 border border-gray-600 rounded-xl p-6 shadow-lg backdrop-blur-md 
